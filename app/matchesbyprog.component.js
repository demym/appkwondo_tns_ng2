...
var MatchesByProgComponent = (function () {
    function MatchesByProgComponent(glb, router) {
        this.glb = glb;
        this.router = router;
        this.mbp = [];
        this.matchesbyprog = [];
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], MatchesByProgComponent.prototype, "garaid", void 0);
    MatchesByProgComponent = __decorate([
        ...
        __metadata('design:paramtypes', [globals_service_1.GlobalsService, router_1.Router])
