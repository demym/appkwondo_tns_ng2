...
exports.AppRoutes = [
    ...
    { path: "matchesforatleta", component: matchesforatleta_component_1.MatchesForAtletaComponent },
];
//enableProdMode();
application_1.nativeScriptBootstrap(app_component_1.AppComponent, [http_1.HTTP_PROVIDERS, http_1.Http, [router_1.nsProvideRouter(exports.AppRoutes, {})]]);
